...
//#include <math.h>
void ComputeOneCell(write_only image2d_t t_cellVDendPtr, global mod_prec *cellCompParamsPtr, StepData step)
{
...
**/
__kernel void compute_kernel(write_only image2d_t t_cellVDendPtr, global mod_prec *cellStatePtr, global mod_prec *cellCompParamsPtr, const mod_prec iApp, const uint i)
{
    ...
    ComputeOneCell(t_cellVDendPtr,cellCompParamsPtr, step);
